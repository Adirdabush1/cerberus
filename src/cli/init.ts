/**
 * `agentguard init [--agent claude|codex|cursor|cline] [--global] [--print]` — wire Cerberus's hook
...
const CLINE_SCRIPT = (): string => `#!/bin/sh\n# Cerberus hook for Cline — auto-generated by \`agentguard init --agent cline\`.\nexec node "${BIN}" hook --agent cline\n`;
